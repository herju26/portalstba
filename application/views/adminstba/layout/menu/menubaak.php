            <ul class="nav">
              ...
              <ul class="dropdown-menu">
                <li><a href="<?php echo site_url('admin/baak/mahasiswa') ?>"><font color="black"><i class="pe-7s-science"></i><p>Mahasiswa</p></a></font></li>
                ...
                <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="pe-7s-date"></i><p>PENGUMUMAN<b class="caret"></b></p></a>
              <ul class="dropdown-menu">
                ...
                <li>
                    <a href="<?php echo site_url('admin/baak/jadwal') ?>">
